...
public class ShopManager : MonoBehaviour
{
        ...
        for (int i = 0; i < meleeWeapon.Length; i++)
        {
            ...
            if (currentWeapon.weaponName == meleeWeapon[i].weaponName)
            {
                ...
                if (i == 0)
                {
                    ...
                    currentWeapon = meleeWeapon[meleeWeapon.Length - 1];
                }
                else
                {
        ...
        if (currentWeapon.owned == true)
        {
            for (int i = 0; i < meleeWeapon.Length; i++) 
            {
                if (currentWeapon.weaponName == meleeWeapon[i].weaponName)
                {
                    ...
                    meleeWeapon[i].equipped = true;
                    currentWeapon.equipped = true;
                    // Sends data about weapon to the weapon item slot
                    MeleeWeaponSlot.AddItem(meleeWeapon[i]);
                }
                else 
                {
                    meleeWeapon[i].equipped = false;
                }
            }
    ...
    public void UpdateGui(MeleeWeapon mW) 
    {
